...
if __name__ == '__main__':
    ...
    for _class in _classes:
        ...
        if os.path.exists(join(model_path, 'full_finetuned_training_losses.pkl')):
            print_and_add_to_log("Already trained!", logging)
            continue
        ...
        try:
            plot_graphs(training_losses, val_losses, training_losses, val_losses, path_to_save=base_feature_path)
